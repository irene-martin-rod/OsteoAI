...
def create_image_dataset(base_path, subset="training", validation_split=0.1, color_mode="rgb", image_size=(256, 256), batch_size=20, label_mode="categorical", seed=42):
    """
    ...
    AParameters:
        ...
        label_mode (str): Labeling mode ('categorical', 'int', or None). Default is 'categorical'.
